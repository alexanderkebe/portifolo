...
export function initPhysicsSandbox() {
  ...
  const brandLogos = {
    ...
    nodejs: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L3 7v10l9 5 9-5V7l-9-5zm6.5 13.9c-.3.4-.8.7-1.3.8-.5.1-1 0-1.4-.2-.4-.2-.8-.6-1.1-.9-.2-.3-.4-.7-.5-1.1-.1-.4 0-.8.2-1.2.2-.4.6-.7.9-.9.3-.2.8-.3 1.2-.2.5.1.9.4 1.2.8.3.3.4.8.4 1.2-.1.6-.3 1.1-.6 1.5zm-5-3.3c-.4.4-.9.6-1.5.6s-1-.2-1.4-.6c-.4-.4-.6-.9-.6-1.5s.2-1 .6-1.4c.4-.4.9-.6 1.4-.6s1 .2 1.5.6c.4.4.6.9.6 1.5s-.2 1-.6 1.4z"/></svg>`,
    typescript: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M2 2h20v20H2V2zm18.4 17.2c0-1.8-1.2-3-3.6-3-1 0-2 .2-2.8.7l.6 2.2c.6-.3 1.2-.5 1.8-.5.8 0 1.2.3 1.2.8 0 .5-.4.7-1 .9-.9.3-2.2.7-2.2 2.3 0 1.4 1 2.2 2.6 2.2 1.3 0 2.2-.4 2.8-.9l-.6-2.1c-.5.3-1.1.5-1.6.5-.6 0-1-.2-1-.7 0-.5.5-.7 1-.9.9-.4 2.2-.7 2.2-2.5zm-8.6-2.2H10v1.8h2.3v6H13v-6h2.3v-1.8H13z"/></svg>`,
    postgresql: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a10 10 0 0 0-8.5 15.2c.4-.3.8-.6 1.3-.9A8 8 0 0 1 12 4a8 8 0 0 1 7.2 11.3c.5.3.9.6 1.3.9A10 10 0 0 0 12 2zm-2 9.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm7 0a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/></svg>`,
    mongodb: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 1.5c-.3 1.2-1.4 3.7-2.3 6-1.4 3.6-2.7 7-2.7 8.5 0 3.3 2.2 6 5 6s5-2.7 5-6c0-1.5-1.3-4.9-2.7-8.5-.9-2.3-2-4.8-2.3-6zm-.8 9.5c.4-1.2.8-2.5 1.1-3.5.3 1 .7 2.3 1.1 3.5H11.2z"/></svg>`,
    vercel: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M24 22.5H0L12 1.5l12 21z"/></svg>`,
    docker: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M13.983 8.871h-2.73V6.299h2.73v2.572zm-3.237 0H8.016V6.299h2.73v2.572zm0 3.29H8.016v-2.571h2.73v2.571zm-3.237 0H4.779v-2.571h2.73v2.571zm0-3.29H4.779V6.299h2.73v2.572zm-3.236 0H1.542V6.299h2.73v2.572zm0 3.29H1.542v-2.571h2.73v2.571zm6.473 3.29h-2.73v-2.571h2.73v2.571zm3.237 0h-2.73v-2.571h2.73v2.571zm3.237-3.29h-2.73v-2.571h2.73v2.571zm0-3.29h-2.73V6.299h2.73v2.572zm3.237 3.29h-2.73v-2.571h2.73v2.571zM23.99 13.93c-.474-.336-1.19-.247-1.624.167-.788.751-2.274.654-3.13-.154l-.066-.065c-.244-.244-.457-.525-.635-.831-.059-.101-.13-.201-.19-.301-.89-1.488-2.613-2.482-4.577-2.482h-11.4v7.7c0 .82.68 1.49 1.5 1.49h15.01c.78-.01 1.43-.61 1.49-1.39l.2-2.12c.07-.63.42-1.18.99-1.47l.43-.22c.6-.32.96-.94.99-1.61.02-.3-.06-.59-.2-.83z"/></svg>`,
    firebase: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3.89 15.67L5.26 6.8c.11-.71.86-1.09 1.41-.69l2.75 2.01-4.03 7.55zm14.85-2.01l-1.9-3.6-1.6 3.01 3.5 3.59c.5.5 1.3.2 1.3-.5l-1.3-2.5zm-5.7-7.8l-1.8 3.5 1.8 3.4 3.7-7c.3-.6-.3-1.3-.9-.9l-2.8 1z"/></svg>`,
    postman: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 15c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm2.5-6.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-5 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm2.5 4c-1.66 0-3-1.34-3-3h6c0 1.66-1.34 3-3 3z"/></svg>`,
    github: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2A10 10 0 0 0 2 12c0 4.42 2.87 8.17 6.84 9.5.5.08.66-.23.66-.5v-1.69c-2.77.6-3.36-1.34-3.36-1.34-.46-1.16-1.11-1.47-1.11-1.47-.9-.62.07-.6.07-.6 1 .07 1.53 1.03 1.53 1.03.9 1.52 2.34 1.07 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.92 0-1.11.38-2 1.03-2.71-.1-.25-.45-1.29.1-2.64 0 0 .84-.27 2.75 1.02.79-.22 1.65-.33 2.5-.33.85 0 1.71.11 2.5.33 1.91-1.29 2.75-1.02 2.75-1.02.55 1.35.2 2.39.1 2.64.65.71 1.03 1.6 1.03 2.71 0 3.82-2.34 4.66-4.57 4.91.36.31.69.92.69 1.85V21c0 .27.16.59.67.5C19.14 20.16 22 16.42 22 12A10 10 0 0 0 12 2z"/></svg>`,
    trello: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-10 15H6c-.55 0-1-.45-1-1V6c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v11c0 .55-.45 1-1 1zm9-5h-3c-.55 0-1-.45-1-1V6c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v6c0 .55-.45 1-1 1z"/></svg>`,
    python: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.97 2c-1.35 0-2.49.12-3.3.42-1.99.73-2.1 1.88-2.1 3.98v1.65H10v.75H5.8c-2.09 0-3.24.21-3.97 2.14-.73 1.93-.73 3.56-.73 5.8s0 3.87.73 5.8c.73 1.93 1.88 2.14 3.97 2.14h1.65v-3.3H10v-.75h4.4v.75H12v3.3h1.65c2.09 0 3.24-.21 3.97-2.14.73-1.93.73-3.56.73-5.8s0-3.87-.73-5.8c-.73-1.93-1.88-2.14-3.97-2.14h-1.65V4.75H14v-.75H9.6v.75H12V2h-.03zM9 5a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm6 12a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/></svg>`,
    jest: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15.93c-3.13-.39-5.5-3.05-5.5-6.23a6.3 6.3 0 0 1 4.5-6.05V8.5a1 1 0 0 0 2 0V5.65c2.58.48 4.5 2.76 4.5 5.51a6.3 6.3 0 0 1-5.5 6.23v-1.46c0-.55-.45-1-1-1s-1 .45-1 1v1.46z"/></svg>`
  };
  ...
  // Define brands to spawn (all 20 brands for a full-featured, packed stack!)
  const brandsToSpawn = [
    'react', 'angular', 'photoshop', 'aftereffects', 'figma', 'premiere', 'flutter', 'illustrator',
    'nodejs', 'typescript', 'postgresql', 'mongodb', 'vercel', 'docker', 'firebase', 'postman',
    'github', 'trello', 'python', 'jest'
  ];
