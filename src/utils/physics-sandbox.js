...
export function initPhysicsSandbox() {
  ...
  const brandLogos = {
    ...
    postman: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L9 9H5l3 4-2 7 6-4 6 4-2-7 3-4h-4l-3-7z"/></svg>`,
    ...
    trello: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-9 14c0 .55-.45 1-1 1H6c-.55 0-1-.45-1-1V6c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v11zm9-5c0 .55-.45 1-1 1H-3c-.55 0-1-.45-1-1V6c0-.55.45-1 1-1h3c.55 0 1 .45 1 1v6z"/></svg>`,
    python: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.9 2c-1.3 0-2.4.1-3.2.4-1.9.7-2 1.8-2 3.8v1.6H10v.7H5.6c-2 0-3.1.2-3.8 2.1-.7 1.9-.7 3.5-.7 5.7s.1 3.8.7 5.7c.7 1.9 1.8 2 3.8 2h1.6V20H6v-.7h4.8c1.3 0 2.4-.1 3.2-.4 1.9-.7 2-1.8 2-3.8v-1.6H12v-.7h4.4c2 0 3.1-.2 3.8-2.1.7-1.9.7-3.5.7-5.7s-.1-3.8-.7-5.7c-.7-1.9-1.8-2-3.8-2h-1.6V4h1.2v.7H9.2c-1.3 0-2.4.1-3.2.4z"/></svg>`,
    jest: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-3zm0 6c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm-4 8h8v2H8v-2z"/></svg>`
  };
